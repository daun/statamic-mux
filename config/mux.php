...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The addon enables animated GIF thumbnails of videos in the control panel,
    | generated by and loaded from Mux's thumbnail CDN. You can disable this
    | entirely to save bandwidth or disable animation and load stills instead.
    |
    */
