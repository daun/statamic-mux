...
class MuxService
{
    ...
    public function createMuxAsset(Asset|string $asset, bool $force = false): ?string
    {
        ...
        if (!$force && $existingMuxAsset->existsOnMux()) return null;
    ...
    {
        if (!$this->isSigned($asset)) return null;
